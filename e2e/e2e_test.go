...
func TestE2E_SingleH1(t *testing.T) {
	t.Run("MultipleH1Violation", func(t *testing.T) {
		output, err := runTestWithCmd(t, "fixtures/multiple_h1.md", "--config", "config-single-h1-only.json")
		if err == nil {
